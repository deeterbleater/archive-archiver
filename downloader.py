...
def download_file(file_row, bucket_dir=DEFAULT_RAW_BUCKET_DIR, limiter=None, max_bytes=None):
...
def download_pending(limit=10, bucket_dir=DEFAULT_RAW_BUCKET_DIR, requests_per_second=0.2, max_bytes=None):
